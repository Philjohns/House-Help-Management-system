...
<!--     SIDE AREA -->
    <div class="sideArea">
        <div class="avatar">
            <img src="img/slides/profile pic.jpg" alt="">
            <div class="avatarName">Welcome,<br>Phillip Ogutu</div>
        </div>
        <ul class="sideMenu">
    ...
    <div class="mainArea">
        ...
        <nav class="navTop row">
            ...
            <div class="account fr">
                <div class="name has-submenu">Phillip Ogutu<span class="fa fa-angle-down"></span></div>
                <ul class="accountLinks submenu">
                    <li><a href="index.php">View website</a></li>
                    <li><a href="logout.php">Log out<span class="fa fa-sign-out fr"></span></a></li>
                </ul>
            </div>
        </nav>
        <!-- END NAV -->
