                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav"><a class="nav-link" href="login.html">Personal Details</a><a class="nav-link" href="employeradminpage.php"></a><a class="nav-link" href="employeradminpage.php">Documents</a></nav>
                                    </div>
                        ...
                        <div class="row">
                             <div style="position: center;" class="table-responsive">
                                   ...
                                   <div style="background-color: green;" class="welcome"><marquee>
                                            ...
                                            <h3 style="margin-left: 40%; color: blue;">Documents</h3>
                                            <h3>Carriculam Vitae</h3>
                                            <?php echo readfile('src="img/profile/'.$paths.'"/')?>
