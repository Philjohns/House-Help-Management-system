      ...
      <div class="menu-quick-contacts-container">
       ...
       <div class="col c5 Omega">
        <div class="menu-top-bar-menu-container">
          ...
          <a href="employerlogin.php">Log in<span>|</span></a>
          </li>
...
if (isset($_REQUEST['username'])){
  ...
  move_uploaded_file($_FILES["prof"]["tmp_name"], $target_file);
    $query = "INSERT into `employer` (id_no, username, fname, lname, email, phone, city, gender, age, password, confirm_password, prof, about_yourself )
VALUES ('$id_no', '$username','$fname','$lname','$email','$phone','$city','$gender','$age','$password','$confirm_password','$pic','$about_yourself')";
