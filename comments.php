                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                             <div style="position: center;" class="table-responsive">
                                        ...
                                        <h3>User Comments</h3>
                                        <table style="background-color: grey;" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th>Name</th>
                                                <th>phone</th>
                                        ...
                                        <tr>
                                             ...
                                             <td><?php echo $Comments ->name; ?></td>
                                               <td><?php echo $Comments ->contnumber; ?></td>
                                                <td><?php echo $Comments ->emaill; ?></td>
                                                 <td><?php echo $Comments ->message; ?></td>
                                            </tr>
                                       </tbody>
                                       </form>
                                   <?php } ?>
