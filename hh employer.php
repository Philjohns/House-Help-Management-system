      ...
      <hr style="border: 3px;s">      
        ...
        <div class="col-md-4 text-center">
            <div class="profile">
                ...
                <li><b>Age:</b> 24 </li>
                <li><b>Id:</b> 3377552</li> 
                <li><b>Phone:</b> 0701077552</li>   
                <li><b>Country:</b> Kenya</li>  
                <li><b>Current Contract:</b><font color="green"> 12/01/2019</font></li>      
                <li><b>End OF Contract:</b><font color="red"> 12/01/2022 </font>  </li>
                <li><b>CV:</b> <button style="background-color: green;"><i class="fa fa-download"></i>Download</button></li>
                </ul>
                </div>
                </p>
                <p>Am a hard working man, self disciplned and love cooking and cleaning <button style="background-color: gold;"><i class="fa fa-phone"></i>Call Me Now.</button></p>
                </div>
                </div>
            <div class="col-md-4 text-center">
            <div class="profile">
